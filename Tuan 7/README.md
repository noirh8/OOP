...
chỉ xét hình chữ nhật và hình vuông có cạnh song song với trục toạ độ. Viết chương trình cho phép nhập vào một trong các hình kể trên. Xuất thông tin hình
đã nhập.
