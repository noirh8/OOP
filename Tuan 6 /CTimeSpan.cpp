...
int main()
{
	...
	cout << "Bang nhau: "; (time1 == time2) ? (cout << "true") : (cout << "false");	
	cout << endl;
	cout << "Khac nhau: "; (time1 != time2) ? (cout << "true") : (cout << "false");
	cout << endl;
	cout << "Lon hon: "; (time1 > time2) ? (cout << "true") : (cout << "false");
	cout << endl;
	cout << "Lon hon hoac bang: "; (time1 >= time2) ? (cout << "true") : (cout << "false");
	cout << endl;
	cout << "Be hon: "; (time1 < time2) ? (cout << "true") : (cout << "false");
	cout << endl;
	cout << "Be hon hoac bang: "; (time1 <= time2) ? (cout << "true") : (cout << "false");
	cout << endl;
	return 0;
}
