...
double DaThuc::evaluate_polynomial(double* x, int NumberOfElement, double y)
{
    double result = 0.0;
...
int main() {
    ...
    double result1 = DT1.evaluate_polynomial(DT1.x, DT1.NumberOfElement, DT1x);
    cout << result1 << endl;
    cout << "Nhap gia tri x cua da thuc 2: "; cin >> DT2x;
    cout << "Gia tri cua da thuc 2 tai x = " << DT2x << " = ";
    double result2 = DT2.evaluate_polynomial(DT2.x, DT2.NumberOfElement, DT2x);
    cout << result2 << endl;
    return 0;
}
